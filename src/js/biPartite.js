!function(){
    ...
    var c1=[-170, 40], c2=[-20, 170], c3=[-10, 160]; //Column positions of labels.
    ...
    bP.partData = function(data,p){
        ...
        sData.keys=[
            d3.set(data.map(function(d){ return d[0];})).values().reverse(),
    ...
    function drawHeader(header, id){
        ...
        [0,1].forEach(function(d){
            ...
            h.append("text").text("Votos").attr("x", (c2[d]-30))
                .attr("y", -5).style("fill","grey");
